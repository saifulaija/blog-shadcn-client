...
import { moderatorColumn } from './components/column'
import { ModeratorDataTable } from './components/moderatorDataTable'
...
<div className="w-full">
  ...
  <div className="flex-grow">
    {isLoading ? (
      ...
      <ModeratorDataTable data={data ?? []} columns={moderatorColumn} />
    )}
  </div>
</div>
